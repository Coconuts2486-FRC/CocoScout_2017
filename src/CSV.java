...
public class CSV {
	...
	public void WriteToFile(Model_View_Stats stats, String x,String time){
		
		WriteToFile(stats, System.getProperty("user.dir") + "//"+x+"-"+time+".csv", true);
	}
